...
// Income category colors for the chart
const INCOME_CATEGORY_COLORS: Record<string, string> = {
  "Salário": "hsl(160, 84%, 39%)",
  "Freelance": "hsl(217, 91%, 60%)",
  "Investimentos": "hsl(271, 81%, 56%)",
  "Aluguel": "hsl(38, 92%, 50%)",
  "Vendas": "hsl(24, 95%, 53%)",
  "Bônus": "hsl(199, 89%, 48%)",
...
export default function IncomeDetails() {
  ...
  // Filter transactions by billingMonth and other filters (only income type)
  ...
  }, [transactions, selectedDate, categoryFilter, searchQuery]);

  // Get unique categories from income transactions
  ...
  const categoryData = useMemo(() => {
    ...
    return Object.entries(byCategory)
      .map(([name, value], index) => ({
        ...
        fill: INCOME_CATEGORY_COLORS[name] || getRandomColor(index),
      }))
  ...
  const summaryMetrics = useMemo(() => {
    ...
    return { totalIncome, averagePerTransaction, topCategory };
